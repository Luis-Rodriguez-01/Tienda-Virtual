...
const WomanFashion = () => {
  ...
  const filteredProducts = herramientas.filter(product => {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-red-600 to-sky-400 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl font-bold mb-4">Herrmientas de todo tipo</h1>
          <p className="text-lg text-white/90">
            Descubre las herramientas más eficaces
          </p>
        </div>
      </div>
